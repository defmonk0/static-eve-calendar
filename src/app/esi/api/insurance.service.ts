...
export class InsuranceService {
     ...
     */
    public getInsurancePrices(datasource?: string, language?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetInsurancePrices200Ok>> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/insurance/prices/`, 
        {
