...
export class KillmailsService {
     ...
     */
    public getCharactersCharacterIdKillmailsRecent(characterId: number, datasource?: string, maxCount?: number, maxKillId?: number, token?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetCharactersCharacterIdKillmailsRecent200Ok>> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/characters/${encodeURIComponent(String(characterId))}/killmails/recent/`, 
        {
     ...
     * Get a list of corporation&#39;s recent kills and losses  --- Alternate route: &#x60;/v1/corporations/{corporation_id}/killmails/recent/&#x60;  Alternate route: &#x60;/legacy/corporations/{corporation_id}/killmails/recent/&#x60;  Alternate route: &#x60;/latest/corporations/{corporation_id}/killmails/recent/&#x60;  --- This route is cached for up to 3600 seconds
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getCorporationsCorporationIdKillmailsRecent(corporationId: number, datasource?: string, maxKillId?: number, token?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetCorporationsCorporationIdKillmailsRecent200Ok>> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/corporations/${encodeURIComponent(String(corporationId))}/killmails/recent/`, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getKillmailsKillmailIdKillmailHash(killmailHash: string, killmailId: number, datasource?: string, userAgent?: string, xUserAgent?: string): Observable<GetKillmailsKillmailIdKillmailHashOk> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/killmails/${encodeURIComponent(String(killmailId))}/${encodeURIComponent(String(killmailHash))}/`, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
