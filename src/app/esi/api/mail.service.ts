...
export class MailService {
     ...
     */
    public deleteCharactersCharacterIdMailLabelsLabelId(characterId: number, labelId: number, datasource?: string, token?: string, userAgent?: string, xUserAgent?: string): Observable<{}> {
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public deleteCharactersCharacterIdMailMailId(characterId: number, mailId: number, datasource?: string, token?: string, userAgent?: string, xUserAgent?: string): Observable<{}> {
        if (characterId === null || characterId === undefined) {
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getCharactersCharacterIdMail(characterId: number, datasource?: string, labels?: Array<number>, lastMailId?: number, token?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetCharactersCharacterIdMail200Ok>> {
        if (characterId === null || characterId === undefined) {
        ...
        return this.httpClient.get<any>(`${this.basePath}/characters/${encodeURIComponent(String(characterId))}/mail/`, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getCharactersCharacterIdMailLabels(characterId: number, datasource?: string, token?: string, userAgent?: string, xUserAgent?: string): Observable<GetCharactersCharacterIdMailLabelsOk> {
        if (characterId === null || characterId === undefined) {
        ...
        return this.httpClient.get<any>(`${this.basePath}/characters/${encodeURIComponent(String(characterId))}/mail/labels/`, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getCharactersCharacterIdMailLists(characterId: number, datasource?: string, token?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetCharactersCharacterIdMailLists200Ok>> {
        if (characterId === null || characterId === undefined) {
        ...
        return this.httpClient.get<any>(`${this.basePath}/characters/${encodeURIComponent(String(characterId))}/mail/lists/`, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getCharactersCharacterIdMailMailId(characterId: number, mailId: number, datasource?: string, token?: string, userAgent?: string, xUserAgent?: string): Observable<GetCharactersCharacterIdMailMailIdOk> {
        if (characterId === null || characterId === undefined) {
        ...
        return this.httpClient.get<any>(`${this.basePath}/characters/${encodeURIComponent(String(characterId))}/mail/${encodeURIComponent(String(mailId))}/`, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public postCharactersCharacterIdMail(characterId: number, mail: PostCharactersCharacterIdMailMail, datasource?: string, token?: string, userAgent?: string, xUserAgent?: string): Observable<number> {
        if (characterId === null || characterId === undefined) {
        ...
        return this.httpClient.post<any>(`${this.basePath}/characters/${encodeURIComponent(String(characterId))}/mail/`, mail, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public postCharactersCharacterIdMailLabels(characterId: number, datasource?: string, label?: PostCharactersCharacterIdMailLabelsLabel, token?: string, userAgent?: string, xUserAgent?: string): Observable<number> {
        if (characterId === null || characterId === undefined) {
        ...
        return this.httpClient.post<any>(`${this.basePath}/characters/${encodeURIComponent(String(characterId))}/mail/labels/`, label, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public putCharactersCharacterIdMailMailId(characterId: number, contents: PutCharactersCharacterIdMailMailIdContents, mailId: number, datasource?: string, token?: string, userAgent?: string, xUserAgent?: string): Observable<{}> {
        if (characterId === null || characterId === undefined) {
        ...
        return this.httpClient.put<any>(`${this.basePath}/characters/${encodeURIComponent(String(characterId))}/mail/${encodeURIComponent(String(mailId))}/`, contents, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
