...
export class IndustryService {
     ...
     */
    public getCharactersCharacterIdIndustryJobs(characterId: number, datasource?: string, includeCompleted?: boolean, token?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetCharactersCharacterIdIndustryJobs200Ok>> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/characters/${encodeURIComponent(String(characterId))}/industry/jobs/`, 
        {
     ...
     * List industry jobs run by a corporation  --- Alternate route: &#x60;/v1/corporations/{corporation_id}/industry/jobs/&#x60;  Alternate route: &#x60;/legacy/corporations/{corporation_id}/industry/jobs/&#x60;  Alternate route: &#x60;/latest/corporations/{corporation_id}/industry/jobs/&#x60;  --- This route is cached for up to 300 seconds
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getCorporationsCorporationIdIndustryJobs(corporationId: number, datasource?: string, includeCompleted?: boolean, page?: number, token?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetCorporationsCorporationIdIndustryJobs200Ok>> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/corporations/${encodeURIComponent(String(corporationId))}/industry/jobs/`, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getIndustryFacilities(datasource?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetIndustryFacilities200Ok>> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/industry/facilities/`, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getIndustrySystems(datasource?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetIndustrySystems200Ok>> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/industry/systems/`, 
        {
            params: queryParameters,
            headers: headers,
            withCredentials: this.configuration.withCredentials,
