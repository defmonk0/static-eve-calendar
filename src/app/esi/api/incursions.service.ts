...
export class IncursionsService {
     ...
     */
    public getIncursions(datasource?: string, userAgent?: string, xUserAgent?: string): Observable<Array<GetIncursions200Ok>> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/incursions/`, 
        {
